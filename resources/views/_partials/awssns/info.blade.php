<div class="bg-light mt-3 p-3 border rounded">
    ...
    <ol class="pl-3 mb-0">
        <li>First, go to the
            ...
            AWS account and purchase an SMS-enabled phone number through AWS Pinpoint.
        </li>
        <li>From your AWS console dashboard, create an IAM role and take down the Key and Secret</li>
        <li>Enter your Key and Secret below, and click on Save Changes.</li>
        <li>That's it! AWS SMS channel has been configured!</li>
    </ol>
</div>
